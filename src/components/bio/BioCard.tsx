  ...
  return (
    <div className="space-y-4">
      <p className="text-secondary leading-relaxed text-lg">
        I'm Towhid (he/him), a graduate from the <a href="https://cse.buet.ac.bd/">Department of CSE, BUET</a>. I am currently working as a software engineer at Therap BD Ltd., a US-based company, 
