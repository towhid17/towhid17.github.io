  ...
  return (
    <div className="glass-card overflow-hidden group transition-all duration-300 hover:shadow-xl">
      ...
      <div className="p-6">
              ...
              <div className="absolute right-0 top-full mt-2 p-2 glass-card rounded-lg shadow-lg z-10">
                <div className="flex flex-col gap-2">
                  <button 
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-lg hover:bg-white/10 transition-colors text-primary"
                  >
        ...
        <h3 className="text-xl font-semibold text-primary group-hover:text-accent transition-colors mb-3">
          {item.title}
        </h3>
        
        {expanded ? (
          <div 
            className="text-primary leading-relaxed space-y-4"
