...
export const newsItems: NewsItem[] = [
  {
    ...
    date: '2024-06-15',
    title: 'How To\'s',
    description: 'Some important how to\'s for research students',
    content: `
      <ul">

                        <li class="px-4 py-2 rounded-full glass-card mb-3"><a href="https://greatresearch.org/2013/08/14/managing-your-advisor/"> How to manage your advisor </a></li>
 
                        <li class="px-4 py-2 rounded-full glass-card mb-3"><a href="https://greatresearch.org/"> How to do great research </a></li>


                        <li class="px-4 py-2 rounded-full glass-card mb-3"><a href="https://www.cc.gatech.edu/fac/Spencer.Rugaber/txt/researchPaper.html"> How to read research papers </a></li>

 
                        <li class="px-4 py-2 rounded-full glass-card mb-3"><a href="https://matt-welsh.blogspot.com/2016/04/why-i-gave-your-paper-strong-reject.html?m=1"> How to write a bad paper </a></li>


                        <li class="px-4 py-2 rounded-full glass-card mb-3"><a href="https://cyberlab.usask.ca/howto-paper.pdf"> How to write a good security paper </a></li>     


                        
                        <li class="px-4 py-2 rounded-full glass-card mb-3"><a href="https://drive.google.com/file/d/0Bzis5MXW83vCdUdXYnFIVDVOSkE/view?resourcekey=0-z3gPdGk4ptNuguAM8e8liQ"> How to have a bad career in research </a></li>


                        <li class="px-4 py-2 rounded-full glass-card mb-3"><a href="https://www.cis.upenn.edu/~sweirich/talks/plmw15-giving-a-talk.pdf">  How to present your research work </a></li>


                        <li class="px-4 py-2 rounded-full glass-card mb-3"><a href="https://www.cs.princeton.edu/~jrex/advice.html"> How to have a successful and rewarding career </a></li>
